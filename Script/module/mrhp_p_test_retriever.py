...
from Script.models.mrhp_1.hdr_search import HDRSearch
from Script.models.mrhp_1.index_saver import IndexSaver
from Script.models.mrhp_1.main_model import IndexScorer
from Script.models.mrhp_1.residual import ResidualCodec
from Script.models.mrhp_1.util import optimize_ivf
...
class PlaidHDRC_PTestRetriever(Retriever):
    ...
    # def run_retrieve(self, queries_dict, query_ids, corpus_id, streaming_step=0):
    ...
    #             query_vecs_array = query_vecs_array[:, 2:,:]  # 去掉 [Q] 标记对应的向量
    ...
    def set_up_index_time_folder(self):
        ...
        layer = self.config["run_config"].get('l_max')
        beta = self.config["run_config"].get("beta")
        update_threshold_radius = self.config["run_config"].get("update_threshold_radius")
        param = r"{}_{}_{}".format(str(layer), str(beta), str(update_threshold_radius))
    ...
    def set_up_retrieve_result_path(self, task=1):
        ...
        analysis_save_folder = r"{}/{}/{}/{}/{}/{}/analysis_task_{}".format(root, model_name, benchmark_type,
                                                                   dataset,  param, iteration, str(task))
...
if __name__ == '__main__':
    ...
    retriever = PlaidHDRC_PTestRetriever(config)
