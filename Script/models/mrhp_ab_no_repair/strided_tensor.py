...
from models.mrhp_ab_no_repair.strided_tensor_core import StridedTensorCore, _create_mask
...
class StridedTensor(StridedTensorCore):
    ...
    def try_load_torch_extensions(cls, use_gpu):
        ...
        print(f"Loading segmented_lookup_cpp extension (set COLBERT_LOAD_TORCH_EXTENSION_VERBOSE=True for more info)...")
    ...
    def lookup(self, pids, output='packed'):
        # 得到了每一个中心的Id后，根据中心Id，查找对应的文档
        # pids:中心的id， lengths 是中心的文档数量， offsets 是中心的起始位置
        # self.tensor,就是所有类当中存在一起的文档的一维储存方式
